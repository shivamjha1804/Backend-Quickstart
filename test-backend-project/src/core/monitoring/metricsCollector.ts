...
export class MetricsCollector {
  ...
  private initializeCustomMetrics(): void {
    ...
    this.httpRequestDuration = new Histogram({
      name: 'test-backend-project_http_request_duration_seconds',
    ...
    this.httpRequestsTotal = new Counter({
      name: 'test-backend-project_http_requests_total',
    ...
    this.httpRequestSize = new Histogram({
      name: 'test-backend-project_http_request_size_bytes',
    ...
    this.httpResponseSize = new Histogram({
      name: 'test-backend-project_http_response_size_bytes',
    ...
    this.activeConnections = new Gauge({
      name: 'test-backend-project_active_connections',
      help: 'Number of active connections'
    });

    // Database Connections Gauge
    this.databaseConnections = new Gauge({
      name: 'test-backend-project_database_connections',
    ...
    this.databaseQueryDuration = new Histogram({
      name: 'test-backend-project_database_query_duration_seconds',
    ...
    this.businessMetrics = new Counter({
      name: 'test-backend-project_business_events_total',
    ...
    this.errorRate = new Counter({
      name: 'test-backend-project_errors_total',
    ...
    this.memoryUsage = new Gauge({
      name: 'test-backend-project_memory_usage_bytes',
    ...
    this.cpuUsage = new Gauge({
      name: 'test-backend-project_cpu_usage_percent',
      help: 'CPU usage percentage'
    });

    // Authentication Attempts
    this.authenticationAttempts = new Counter({
      name: 'test-backend-project_auth_attempts_total',
    ...
    this.rateLimitHits = new Counter({
      name: 'test-backend-project_rate_limit_hits_total',
  ...
  createCustomCounter(name: string, help: string, labelNames: string[] = []): Counter<string> {
    const counter = new Counter({
      name: `test-backend-project_${name}`,
      help,
      labelNames
    });
