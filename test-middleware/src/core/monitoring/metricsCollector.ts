...
export class MetricsCollector {
  ...
  private initializeCustomMetrics(): void {
    ...
    this.httpRequestDuration = new Histogram({
      name: 'test-middleware_http_request_duration_seconds',
    ...
    this.httpRequestsTotal = new Counter({
      name: 'test-middleware_http_requests_total',
    ...
    this.httpRequestSize = new Histogram({
      name: 'test-middleware_http_request_size_bytes',
    ...
    this.httpResponseSize = new Histogram({
      name: 'test-middleware_http_response_size_bytes',
    ...
    this.activeConnections = new Gauge({
      name: 'test-middleware_active_connections',
      help: 'Number of active connections'
    });

    // Database Connections Gauge
    this.databaseConnections = new Gauge({
      name: 'test-middleware_database_connections',
    ...
    this.databaseQueryDuration = new Histogram({
      name: 'test-middleware_database_query_duration_seconds',
    ...
    this.businessMetrics = new Counter({
      name: 'test-middleware_business_events_total',
    ...
    this.errorRate = new Counter({
      name: 'test-middleware_errors_total',
    ...
    this.memoryUsage = new Gauge({
      name: 'test-middleware_memory_usage_bytes',
    ...
    this.cpuUsage = new Gauge({
      name: 'test-middleware_cpu_usage_percent',
      help: 'CPU usage percentage'
    });

    // Authentication Attempts
    this.authenticationAttempts = new Counter({
      name: 'test-middleware_auth_attempts_total',
    ...
    this.rateLimitHits = new Counter({
      name: 'test-middleware_rate_limit_hits_total',
